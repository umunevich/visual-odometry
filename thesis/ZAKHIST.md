...
- [ ] Підготувати коротке відео EuRoC (або мати готовий MP4 з `scripts/make_video.py`)
...
2. Завантажити підготовлене відео EuRoC (короткий фрагмент, 10–20 с достатньо).
3. У dropdown обрати профіль **Dataset** або **EuRoC MAV (default)**.
4. Натиснути **Start VO!**
...
> Серед **обмежень**: дрейф без замикання контуру, умовний масштаб траєкторії, залежність від калібрування.
>
> **Перспективи**: кількісна оцінка через ATE/RPE (бібліотека evo), ORB-дескриптори, поєднання з IMU, loop closure.

---

## Слайд 12 — Висновки (4:40–4:55)

> **Підсумовую:** реалізовано веб-систему монокулярної VO з клієнт–серверною архітектурою, модулем калібрування та експериментальною перевіркою на EuRoC. Система придатна для **навчальної демонстрації** та прототипування локалізації БПЛА.
...
| Що таке неоднозначність масштабу? | Глибина відновлюється з точністю до множника; масштаб траєкторії умовний. |
